  ...
  return (
    <footer className="footer">
      <div className="footer__links">
        <div className="footer__wrap footer__logo-wrap">
          <Logo />
          <div className="footer__logo-text">
            <b>1953</b>
            <p>
              Minsk Watch <br /> Factory
            </p>
          </div>
        </div>
        <div className="footer__wrap">
          <Link className="footer__title-link" to="">
            Catalog
          </Link>
          <Link className="footer__sub-link" to="">
            Men's
          </Link>
          <Link className="footer__sub-link" to="">
            Ladies
        ...
        <div className="footer__wrap">
          ...
          <p className="footer__subtitle">Minsk</p>
          <Link className="footer__sub-link" to="">
            Independence Avenue, 95
          </Link>
          <p className="footer__subtitle">Moscow</p>
          <Link className="footer__sub-link" to="">
            Volgogradsky Avenue, 32
          </Link>
        </div>
        <div className="footer__wrap">
          <form
          ...
          >
            <h3 className="footer__form-title">
              Subscribe to news <br /> and promotions
            </h3>
            <div className="footer__form-wrap">
              ...
              />
              <button className="btn btn_gradient footer__form-btn">
                <svg
      ...
      <div className="footer__copy">
        <div className="footer__wrap">
          <p className="footer__copy-text">
            <b>&copy; Since 1953.</b> Minsk Watch Factory "Луч"
          </p>
        </div>
        <div className="footer__wrap">
          <Link className="footer__sub-link" to="">
